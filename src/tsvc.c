...
static char *function_filter = NULL;

void time_function(test_function_t vector_func, const char *fname, void * arg_info)
{
    // filter functions
    if (function_filter != NULL && strcmp (fname, function_filter) != 0)
        return;
...
int main(int argc, char ** argv){
    ...
    if(argc == 2)
        function_filter = argv[1];

    init(&ip, &s1, &s2);
    printf("Loop \tTime(sec) \tChecksum\n");

    time_function(&s000, "s000", NULL);
    time_function(&s111, "s111", NULL);
    time_function(&s1111, "s1111", NULL);
    time_function(&s112, "s112", NULL);
    time_function(&s1112, "s1112", NULL);
    time_function(&s113, "s113", NULL);
    time_function(&s1113, "s1113", NULL);
    time_function(&s114, "s114", NULL);
    time_function(&s115, "s115", NULL);
    time_function(&s1115, "s1115", NULL);
    time_function(&s116, "s116", NULL);
    time_function(&s118, "s118", NULL);
    time_function(&s119, "s119", NULL);
    time_function(&s1119, "s1119", NULL);
    time_function(&s121, "s121", NULL);
    time_function(&s122, "s122", &(struct{int a;int b;}){n1, n3});
    time_function(&s123, "s123", NULL);
    time_function(&s124, "s124", NULL);
    time_function(&s125, "s125", NULL);
    time_function(&s126, "s126", NULL);
    time_function(&s127, "s127", NULL);
    time_function(&s128, "s128", NULL);
    time_function(&s131, "s131", NULL);
    time_function(&s132, "s132", NULL);
    time_function(&s141, "s141", NULL);
    time_function(&s151, "s151", NULL);
    time_function(&s152, "s152", NULL);
    time_function(&s161, "s161", NULL);
    time_function(&s1161, "s1161", NULL);
    time_function(&s162, "s162", &n1);
    time_function(&s171, "s171", &n1);
    time_function(&s172, "s172", &(struct{int a;int b;}){n1, n3});
    time_function(&s173, "s173", NULL);
    time_function(&s174, "s174", &(struct{int a;}){LEN_1D/2});
    time_function(&s175, "s175", &n1);
    time_function(&s176, "s176", NULL);
    time_function(&s211, "s211", NULL);
    time_function(&s212, "s212", NULL);
    time_function(&s1213, "s1213", NULL);
    time_function(&s221, "s221", NULL);
    time_function(&s1221, "s1221", NULL);
    time_function(&s222, "s222", NULL);
    time_function(&s231, "s231", NULL);
    time_function(&s232, "s232", NULL);
    time_function(&s1232, "s1232", NULL);
    time_function(&s233, "s233", NULL);
    time_function(&s2233, "s2233", NULL);
    time_function(&s235, "s235", NULL);
    time_function(&s241, "s241", NULL);
    time_function(&s242, "s242", &(struct{real_t a;real_t b;}){s1, s2});
    time_function(&s243, "s243", NULL);
    time_function(&s244, "s244", NULL);
    time_function(&s1244, "s1244", NULL);
    time_function(&s2244, "s2244", NULL);
    time_function(&s251, "s251", NULL);
    time_function(&s1251, "s1251", NULL);
    time_function(&s2251, "s2251", NULL);
    time_function(&s3251, "s3251", NULL);
    time_function(&s252, "s252", NULL);
    time_function(&s253, "s253", NULL);
    time_function(&s254, "s254", NULL);
    time_function(&s255, "s255", NULL);
    time_function(&s256, "s256", NULL);
    time_function(&s257, "s257", NULL);
    time_function(&s258, "s258", NULL);
    time_function(&s261, "s261", NULL);
    time_function(&s271, "s271", NULL);
    time_function(&s272, "s272", &s1);
    time_function(&s273, "s273", NULL);
    time_function(&s274, "s274", NULL);
    time_function(&s275, "s275", NULL);
    time_function(&s2275, "s2275", NULL);
    time_function(&s276, "s276", NULL);
    time_function(&s277, "s277", NULL);
    time_function(&s278, "s278", NULL);
    time_function(&s279, "s279", NULL);
    time_function(&s1279, "s1279", NULL);
    time_function(&s2710, "s2710", &s1);
    time_function(&s2711, "s2711", NULL);
    time_function(&s2712, "s2712", NULL);
    time_function(&s281, "s281", NULL);
    time_function(&s1281, "s1281", NULL);
    time_function(&s291, "s291", NULL);
    time_function(&s292, "s292", NULL);
    time_function(&s293, "s293", NULL);
    time_function(&s2101, "s2101", NULL);
    time_function(&s2102, "s2102", NULL);
    time_function(&s2111, "s2111", NULL);
    time_function(&s311, "s311", NULL);
    time_function(&s31111, "s31111", NULL);
    time_function(&s312, "s312", NULL);
    time_function(&s313, "s313", NULL);
    time_function(&s314, "s314", NULL);
    time_function(&s315, "s315", NULL);
    time_function(&s316, "s316", NULL);
    time_function(&s317, "s317", NULL);
    time_function(&s318, "s318", &n1);
    time_function(&s319, "s319", NULL);
    time_function(&s3110, "s3110", NULL);
    time_function(&s13110, "s13110", NULL);
    time_function(&s3111, "s3111", NULL);
    time_function(&s3112, "s3112", NULL);
    time_function(&s3113, "s3113", NULL);
    time_function(&s321, "s321", NULL);
    time_function(&s322, "s322", NULL);
    time_function(&s323, "s323", NULL);
    time_function(&s331, "s331", NULL);
    time_function(&s332, "s332", &s1);
    time_function(&s341, "s341", NULL);
    time_function(&s342, "s342", NULL);
    time_function(&s343, "s343", NULL);
    time_function(&s351, "s351", NULL);
    time_function(&s1351, "s1351", NULL);
    time_function(&s352, "s352", NULL);
    time_function(&s353, "s353", ip);
    time_function(&s421, "s421", NULL);
    time_function(&s1421, "s1421", NULL);
    time_function(&s422, "s422", NULL);
    time_function(&s423, "s423", NULL);
    time_function(&s424, "s424", NULL);
    time_function(&s431, "s431", NULL);
    time_function(&s441, "s441", NULL);
    time_function(&s442, "s442", NULL);
    time_function(&s443, "s443", NULL);
    time_function(&s451, "s451", NULL);
    time_function(&s452, "s452", NULL);
    time_function(&s453, "s453", NULL);
    time_function(&s471, "s471", NULL);
    time_function(&s481, "s481", NULL);
    time_function(&s482, "s482", NULL);
    time_function(&s491, "s491", ip);
    time_function(&s4112, "s4112", &(struct{int*a;real_t b;}){ip, s1});
    time_function(&s4113, "s4113", ip);
    time_function(&s4114, "s4114", &(struct{int*a;int b;}){ip, n1});
    time_function(&s4115, "s4115", ip);
    time_function(&s4116, "s4116", &(struct{int * a; int b; int c;}){ip, LEN_2D/2, n1});
    time_function(&s4117, "s4117", NULL);
    time_function(&s4121, "s4121", NULL);
    time_function(&va, "va", NULL);
    time_function(&vag, "vag", ip);
    time_function(&vas, "vas", ip);
    time_function(&vif, "vif", NULL);
    time_function(&vpv, "vpv", NULL);
    time_function(&vtv, "vtv", NULL);
    time_function(&vpvtv, "vpvtv", NULL);
    time_function(&vpvts, "vpvts", &s1);
    time_function(&vpvpv, "vpvpv", NULL);
    time_function(&vtvtv, "vtvtv", NULL);
    time_function(&vsumr, "vsumr", NULL);
    time_function(&vdotr, "vdotr", NULL);
    time_function(&vbor, "vbor", NULL);
